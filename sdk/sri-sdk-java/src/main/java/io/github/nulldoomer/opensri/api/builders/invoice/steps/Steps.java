 ...
 *
 * <p>It backs {@link InvoiceBuilder} and centralizes the mutable state needed to enforce the
 * step-builder flow while keeping the resulting domain entity immutable.
 *
 * @see Invoice
 * @see Totals
 */
