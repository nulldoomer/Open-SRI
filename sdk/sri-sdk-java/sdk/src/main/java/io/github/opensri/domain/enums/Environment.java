 ...
 *
 * <p>Este catálogo corresponde a la tabla Nro. 4 de la documentación del SRI
 * y permite distinguir si el documento se genera para pruebas o para producción,
 * afectando tanto la clave de acceso como los endpoints utilizados por el SDK.
 */
