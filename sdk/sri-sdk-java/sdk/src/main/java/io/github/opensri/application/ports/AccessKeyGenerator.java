 ...
 *
 * <p>This port defines the contract for producing the 49-digit access key required
 * by the SRI to identify a document before submission and authorization checks.
 * Implementations are responsible for combining the document metadata, environment,
 * and verification digit according to SRI rules.
 */
public interface AccessKeyGenerator {
     ...
     *
     * <p>The generated value must be suitable for inclusion in the document XML
     * and for later authorization lookups against the SRI services.
     *
     * @param date issue date of the document being identified
     * @param documentNumber document numbering data, including code, establishment,
     *                       emission point, and sequential number
