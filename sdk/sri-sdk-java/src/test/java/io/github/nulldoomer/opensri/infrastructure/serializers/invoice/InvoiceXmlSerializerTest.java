...
import io.github.nulldoomer.opensri.domain.valueobjects.*;
...
class InvoiceXmlSerializerTest {
    ...
    void setUp() {
        ...
        ImmediatePayment paymentTwoItems = new ImmediatePayment(PaymentMethod.SIN_SISTEMA_FINANCIERO, totalsTwoItems.totalValue());
        ...
        ImmediatePayment paymentTwoTaxes = new ImmediatePayment(PaymentMethod.SIN_SISTEMA_FINANCIERO, totalsTwoTaxes.totalValue());
