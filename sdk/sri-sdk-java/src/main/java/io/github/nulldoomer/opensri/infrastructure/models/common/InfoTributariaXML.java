...
package io.github.nulldoomer.opensri.infrastructure.models.common;
 ...
 *
 * <p>This class contains the issuer identification, environment, access key, and numbering data
 * required by the SRI to recognize the tax document.
 */
...
public class InfoTributariaXML {
  ...
  public static InfoTributariaXML fromDomain(
      TaxInfo taxInfo, DocumentNumber documentNumber, String accessKey, Environment env) {
