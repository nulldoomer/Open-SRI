 ...
 *
 * <p>This builder hides the mutable implementation used during configuration and returns
 * only the first step of the fluent API. The resulting flow guides SDK consumers through
 * the mandatory client settings in the correct order before a client instance can be built.
 *
 * @see Steps
 */
