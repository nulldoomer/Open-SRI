 ...
 *
 * <p>This XML structure maps the optional name-value attributes that can be attached to a specific
 * invoice line under the SRI {@code detallesAdicionales} section.
 */
