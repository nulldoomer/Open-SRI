 ...
 *
 * <p>This port abstracts the transformation of a document model into XML without
 * exposing JAXB or any other serialization technology to the application layer.
 * Implementations are expected to produce XML that matches the corresponding SRI schema.
 *
