 ...
 *
 * <p>This enum centralizes the supported version strings for electronic document payloads so
 * builders and serializers can select the appropriate XML version without hardcoding literal values
 * across the SDK.
 */
